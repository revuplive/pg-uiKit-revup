...
const Footer: React.FC<FooterProps> = (props) => {
  ...
  return(
    ...
    <Column isStacked={isStacked} maxWidth="260px" mb={isStacked ? "2rem" : "0"}>
        ...
        <Text as="p" textAlign={isStacked ? "center" : "left"} fontFamily="Telegraf" fontWeight="200" fontSize=".8rem" color="#B7B5DE" mb="6px">
          The Penguin Finance protocol is bringing 
          yield-farming, staking and more functionalities 
        ...
        <Row isStacked={isStacked} alignItems="flex-end">
          ...
          <Text ml="10px" color="#fff">Audited by Certik</Text>
        </Row>
    </Column>
    {FooterLinks.map(data => (
       <Column isStacked={isStacked}>
       <Text color="#fff" mb="6px">{data.title}</Text>
       {data.links.map(link => (
    ...
    <Column isStacked={isStacked} alignItems="center" maxWidth="350px">
        <Text color="#fff" mb="10px">Official Social Media</Text>
        ...
        <Text color="#fff" mt="1.5rem" mb="10px">Powered by</Text>
