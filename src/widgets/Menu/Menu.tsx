...
const StyledNav = styled.nav<{ showMenu: boolean; isDark: boolean }>`
  ...
  border-color: ${({ isDark }) => isDark && "#0C0B15"};
  z-index: 20;
...
const Menu: React.FC<NavProps> = ({
  ...
  return (
    <Wrapper>
      <StyledNav showMenu={showMenu} isDark={isDark}>
        <Logo
          isPushed={isPushed}
        ...
        <Flex alignItems="center">
          <UserBlock
            account={account}
            nickname={nickname || ""}
            pefiBalance={pefiBalance}
            avaxBalance={avaxBalance}
            iPefiBalance={iPefiBalance}
            login={login}
            logout={logout}
          />
      ...
      <BodyWrapper>
        <Panel
          ...
          penguinPriceUsd={penguinPriceUsd}
          pefiRatio={pefiRatio}
          iPefiRatio={iPefiRatio}
          pushNav={setIsPushed}
          links={links}
          socials={socials}
        />
